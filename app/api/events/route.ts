...
const NEWS_FEEDS: Array<{ url: string; name: string }> = [
  ...
  // ── 러시아·구소련 ────────────────────────────────────────
  { url: 'https://meduza.io/rss/en/all',                           name: 'Meduza RU' },
  { url: 'https://www.themoscowtimes.com/rss',                     name: 'Moscow Times' },
  { url: 'https://english.gordonua.com/rss.xml',                   name: 'Gordon UA EN' },
  { url: 'https://www.eurointegration.com.ua/eng/rss/',            name: 'Euro Integration UA' },
  { url: 'https://www.azatutyun.am/api/zivqrkrvil',                name: 'Azatutyun AM' },
  { url: 'https://rus.azattyq.org/api/zivqrkrvil',                 name: 'Azattyq KZ' },
  { url: 'https://www.currenttime.tv/api/zivqrkrvil',              name: 'Current Time TV' },
  // ── 유럽 추가 ────────────────────────────────────────────
  { url: 'https://www.euractiv.com/sections/all/feed/',            name: 'Euractiv' },
  { url: 'https://www.politico.com/rss/politicopicks.xml',         name: 'Politico US' },
  { url: 'https://www.dw.com/rss/rss/en-all.xml',                  name: 'DW All EN' },
  { url: 'https://www.svt.se/nyheter/rss.xml',                     name: 'SVT Sweden' },
  { url: 'https://www.dn.se/rss/',                                 name: 'Dagens Nyheter SE' },
  { url: 'https://www.nrk.no/nyheter/rss',                        name: 'NRK Norway' },
  { url: 'https://www.yle.fi/uutiset/rss/uutiset.rss',            name: 'YLE Finland' },
  { url: 'https://www.dr.dk/nyheder/service/feeds/allenyheder',   name: 'DR Denmark' },
  { url: 'https://orf.at/stories/rss',                             name: 'ORF Austria' },
  { url: 'https://www.srf.ch/news/bnf/rss/1890',                   name: 'SRF Switzerland' },
  { url: 'https://www.rtbf.be/info/rss',                           name: 'RTBF Belgium' },
  { url: 'https://www.hrt.hr/rss',                                 name: 'HRT Croatia' },
  { url: 'https://n1info.rs/feed/',                                name: 'N1 Serbia' },
  { url: 'https://www.24sata.hr/feeds/news.xml',                   name: '24sata HR' },
  { url: 'https://www.index.hr/rss',                               name: 'Index HR' },
  { url: 'https://www.rtvslo.si/feeds/00.xml',                     name: 'RTV Slovenia' },
  { url: 'https://www.aktuality.sk/rss/',                          name: 'Aktuality SK' },
  { url: 'https://hvg.hu/rss/rss.aspx',                           name: 'HVG Hungary' },
  { url: 'https://www.digi24.ro/rss',                              name: 'Digi24 Romania' },
  { url: 'https://www.novinite.com/rss.php',                       name: 'Novinite Bulgaria' },
  { url: 'https://www.ekathimerini.com/rss/?s=1',                  name: 'Kathimerini GR' },
  { url: 'https://www.haaretz.com/cmlink/1.628765',                name: 'Haaretz IL' },
  { url: 'https://www.timesofisrael.com/feed/',                    name: 'Times of Israel' },
  { url: 'https://www.ynetnews.com/category/3082/rss',             name: 'Ynet News IL' },
  // ── 남아시아 추가 ────────────────────────────────────────
  { url: 'https://www.business-standard.com/rss/home_page_top_stories.rss', name: 'Business Standard IN' },
  { url: 'https://www.ndtv.com/rss/2/',                            name: 'NDTV IN' },
  { url: 'https://www.firstpost.com/rss',                          name: 'Firstpost IN' },
  { url: 'https://scroll.in/feed',                                 name: 'Scroll IN' },
  { url: 'https://thewire.in/rss',                                 name: 'The Wire IN' },
  { url: 'https://www.deccanherald.com/rss',                       name: 'Deccan Herald IN' },
  // ── 동남아시아 추가 ──────────────────────────────────────
  { url: 'https://www.benarnews.org/english/news/rss',             name: 'BenarNews' },
  { url: 'https://www.asean.org/feed/',                            name: 'ASEAN' },
  { url: 'https://www.sunstar.com.ph/feed/',                       name: 'SunStar PH' },
  { url: 'https://en.tempo.co/rss/news',                           name: 'Tempo EN ID' },
  { url: 'https://www.channelnewsasia.com/rss/8395744',            name: 'CNA SE Asia' },
  { url: 'https://www.channelnewsasia.com/rss/8395884',            name: 'CNA Asia Pacific' },
  // ── 동아시아 추가 ────────────────────────────────────────
  { url: 'https://english.kyodonews.net/rss/news.xml',             name: 'Kyodo News 2' },
  { url: 'https://www.rthk.hk/rthk/web/rss/rthk-top-story.xml',  name: 'RTHK HK' },
  { url: 'https://koreajoongangdaily.joins.com/rss/feeds.xml',     name: 'JoongAng Daily KR' },
  { url: 'https://www.koreaherald.com/rss/020100000000.xml',       name: 'Korea Herald 2' },
  // ── 아프리카 추가 ────────────────────────────────────────
  { url: 'https://www.timeslive.co.za/rss/',                       name: 'Times Live ZA' },
  { url: 'https://www.sowetanlive.co.za/rss/',                     name: 'Sowetan ZA' },
  { url: 'https://allafrica.com/tools/headlines/rss/latest/partial.rss', name: 'AllAfrica Latest' },
  { url: 'https://www.dw.com/rss/rss/afr.xml',                     name: 'DW Africa FR' },
  { url: 'https://www.africa24.com/feed/',                         name: 'Africa24' },
  { url: 'https://www.bbc.com/afrique/index.xml',                  name: 'BBC Afrique' },
  { url: 'https://www.voaafrique.com/api/epiqq',                   name: 'VOA Afrique FR' },
  ...
  { url: 'https://nilepost.co.ug/feed/',                           name: 'Nile Post UG' },
  { url: 'https://www.mwebantu.com/feed/',                         name: 'Mwebantu ZM' },
  // ── 중동 추가 ────────────────────────────────────────────
  { url: 'https://www.zawya.com/rss/news/all',                     name: 'Zawya MENA' },
  { url: 'https://www.egypttoday.com/rss',                         name: 'Egypt Today' },
  { url: 'https://sana.sy/?feed=rss2',                             name: 'SANA Syria' },
  { url: 'https://www.presstv.ir/RssFeed/1.xml',                   name: 'PressTV IR' },
  // ── 오세아니아 추가 ──────────────────────────────────────
  { url: 'https://www.smh.com.au/rss/world.xml',                   name: 'Sydney Morning Herald' },
  { url: 'https://www.theage.com.au/rss/world.xml',                name: 'The Age AU' },
  { url: 'https://www.nzherald.co.nz/arc/outboundfeeds/rss/',      name: 'NZ Herald' },
  { url: 'https://www.stuff.co.nz/rss',                            name: 'Stuff NZ' },
  { url: 'https://www.rnz.co.nz/rss/pacific.xml',                  name: 'RNZ Pacific' },
  // ── 국제기구 추가 ────────────────────────────────────────
  { url: 'https://www.unhcr.org/rss/news.xml',                     name: 'UNHCR' },
  { url: 'https://www.unicef.org/press-releases/rss',              name: 'UNICEF' },
  { url: 'https://www.wfp.org/rss.xml',                            name: 'WFP' },
  { url: 'https://www.icrc.org/en/rss',                            name: 'ICRC' },
  { url: 'https://www.savethechildren.net/rss.xml',                name: 'Save the Children' },
  { url: 'https://www.oxfam.org/en/press-room/rss.xml',            name: 'Oxfam' },
  { url: 'https://www.msf.org/rss',                                name: 'MSF' },
  { url: 'https://www.amnesty.org/en/latest/rss/',                 name: 'Amnesty International' },
  { url: 'https://www.hrw.org/rss',                                name: 'Human Rights Watch' },
  { url: 'https://www.transparency.org/en/press/rss',             name: 'Transparency Intl' },
  // ── 경제·금융 추가 ───────────────────────────────────────
  { url: 'https://www.imf.org/en/News/rss',                        name: 'IMF' },
  { url: 'https://www.worldbank.org/en/news/rss',                  name: 'World Bank' },
  { url: 'https://unctad.org/news/rss',                            name: 'UNCTAD' },
  { url: 'https://www.wto.org/english/news_e/news_e.rss',          name: 'WTO' },
  { url: 'https://www.bloomberg.com/feeds/bbiz/sitemap_news.xml',  name: 'Bloomberg' },
  { url: 'https://feeds.marketwatch.com/marketwatch/topstories/',  name: 'MarketWatch' },
  // ── 환경·에너지 추가 ─────────────────────────────────────
  { url: 'https://www.iea.org/newsroom/rss',                       name: 'IEA Energy' },
  { url: 'https://www.irena.org/News/RSS',                         name: 'IRENA' },
  { url: 'https://www.unep.org/news-and-stories/rss',              name: 'UNEP' },
  { url: 'https://e360.yale.edu/feed.rss',                         name: 'Yale E360' },
  { url: 'https://www.climatechangenews.com/feed/',                name: 'Climate Home News' },
  // ── 과학·기술 추가 ───────────────────────────────────────
  { url: 'https://www.wired.com/feed/rss',                         name: 'Wired' },
  { url: 'https://arstechnica.com/feed/',                          name: 'Ars Technica' },
  { url: 'https://phys.org/rss-feed/',                             name: 'Phys.org' },
  { url: 'https://www.spacenews.com/feed/',                        name: 'Space News' },
  { url: 'https://spaceflightnow.com/feed/',                       name: 'Spaceflight Now' },
  // ── 미국·캐나다 로컬 뉴스 ───────────────────────────────
  { url: 'https://www.latimes.com/world/rss2.0.xml',               name: 'LA Times World' },
  ...
  { url: 'https://theintercept.com/feed/?rss',                     name: 'The Intercept' },
  { url: 'https://www.globeandmail.com/arc/outboundfeeds/rss/',    name: 'Globe and Mail CA' },
  { url: 'https://www.ottawacitizen.com/feed/',                    name: 'Ottawa Citizen CA' },
  // ── 영국 추가 ────────────────────────────────────────────
  { url: 'https://www.independent.co.uk/news/world/rss',           name: 'The Independent UK' },
  { url: 'https://www.telegraph.co.uk/news/world/rss.xml',         name: 'The Telegraph UK' },
  { url: 'https://www.thetimes.co.uk/rss/world',                   name: 'The Times UK' },
  { url: 'https://www.spectator.co.uk/feed',                       name: 'The Spectator UK' },
  { url: 'https://www.ft.com/world?format=rss',                    name: 'FT World' },
  { url: 'https://feeds.skynews.com/feeds/rss/world.xml',          name: 'Sky News World' },
  { url: 'https://www.itv.com/news/rss',                           name: 'ITV News UK' },
  // ── 프랑스·독일·스페인 ───────────────────────────────────
  { url: 'https://www.lemonde.fr/rss/une.xml',                     name: 'Le Monde' },
  { url: 'https://www.lefigaro.fr/rss/figaro_international.xml',   name: 'Le Figaro' },
  { url: 'https://www.liberation.fr/arc/outboundfeeds/rss/',       name: 'Libération' },
  { url: 'https://www.lepoint.fr/rss.xml',                         name: 'Le Point' },
  { url: 'https://www.faz.net/rss/aktuell/',                       name: 'FAZ Germany' },
  { url: 'https://www.sueddeutsche.de/news/rss',                   name: 'Süddeutsche Zeitung' },
  { url: 'https://www.zeit.de/news/rss',                           name: 'Die Zeit' },
  { url: 'https://www.handelsblatt.com/contentexport/feed/schlagzeilen', name: 'Handelsblatt' },
  { url: 'https://www.elpais.com/rss/feed.html?feedId=1022',       name: 'El País' },
  { url: 'https://www.elmundo.es/rss/portada.xml',                 name: 'El Mundo ES' },
  { url: 'https://www.abc.es/rss/feeds/abc_EspanaEspana.xml',      name: 'ABC Spain' },
  { url: 'https://www.corriere.it/rss/homepage.xml',               name: 'Corriere della Sera' },
  { url: 'https://www.repubblica.it/rss/homepage/rss2.0.xml',      name: 'La Repubblica IT' },
  { url: 'https://www.lastampa.it/rss',                            name: 'La Stampa IT' },
  // ── 아시아 영문 미디어 추가 ──────────────────────────────
  { url: 'https://www.nikkei.com/rss/news.rss',                    name: 'Nikkei Asia' },
  { url: 'https://asia.nikkei.com/rss/feed/nar',                   name: 'Nikkei Asia EN' },
  { url: 'https://www.asiaone.com/rss.xml',                        name: 'AsiaOne' },
  { url: 'https://thediplomat.com/feed/',                          name: 'The Diplomat' },
  { url: 'https://www.lowyinstitute.org/the-interpreter/rss',      name: 'Lowy Institute' },
  { url: 'https://www.eastasiaforum.org/feed/',                    name: 'East Asia Forum' },
  { url: 'https://www.rfa.org/english/news/china/rss2.xml',        name: 'RFA China' },
  { url: 'https://www.rfa.org/english/news/myanmar/rss2.xml',      name: 'RFA Myanmar' },
  { url: 'https://www.rfa.org/english/news/vietnam/rss2.xml',      name: 'RFA Vietnam' },
  { url: 'https://www.rfa.org/english/news/cambodia/rss2.xml',     name: 'RFA Cambodia' },
  { url: 'https://www.rfa.org/english/news/laos/rss2.xml',         name: 'RFA Laos' },
  // ── 중남미 추가 ──────────────────────────────────────────
  { url: 'https://www.bbc.com/portuguese/rss.xml',                 name: 'BBC Portuguese' },
  { url: 'https://www.bbc.com/mundo/temas/america_latina/rss.xml', name: 'BBC Mundo' },
  { url: 'https://www.telesurtv.net/rss',                          name: 'TeleSUR' },
  { url: 'https://www.elpais.com/rss/feed.html?feedId=3986',       name: 'El País América' },
  { url: 'https://www.laprensa.hn/feed/',                          name: 'La Prensa HN' },
  { url: 'https://www.nacion.com/el-mundo/rss/',                   name: 'La Nación CR' },
  { url: 'https://www.eltiempo.com/rss/mundo.xml',                 name: 'El Tiempo CO' },
  { url: 'https://www.pagina12.com.ar/rss/portada',                name: 'Página 12 AR' },
  { url: 'https://www.lacapital.com.ar/rss/ultimas-noticias.xml',  name: 'La Capital AR' },
  { url: 'https://www.estadao.com.br/rss/ultimas.xml',             name: 'Estadão BR' },
  { url: 'https://www.folha.uol.com.br/poder/rss091.xml',          name: 'Folha de S.Paulo BR' },
  // ── 중앙아시아·코카서스 추가 ────────────────────────────
  { url: 'https://eurasianet.org/rss.xml',                         name: 'EurasiaNet' },
  { url: 'https://www.jamestown.org/feed/',                        name: 'Jamestown Foundation' },
  { url: 'https://www.cabar.asia/en/feed/',                        name: 'CABAR Central Asia' },
  { url: 'https://www.kazinform.com/rss/en',                       name: 'Kazinform KZ' },
  { url: 'https://kun.uz/en/rss',                                  name: 'Kun.uz UZ' },
  { url: 'https://www.georgianjournal.ge/rss',                     name: 'Georgian Journal' },
  { url: 'https://jam-news.net/feed/',                             name: 'JAM News' },
  // ── 서아프리카 추가 ──────────────────────────────────────
  { url: 'https://www.jeuneafrique.com/feed/',                     name: 'Jeune Afrique' },
  { url: 'https://www.lemonde.fr/afrique/rss_full.xml',            name: 'Le Monde Afrique' },
  { url: 'https://www.dw.com/rss/rss/afr.xml',                     name: 'DW Afrique' },
  { url: 'https://www.rfi.fr/afrique/rss',                         name: 'RFI Afrique' },
  { url: 'https://www.voaafrique.com/api/epiqq',                   name: 'VOA Afrique' },
  { url: 'https://www.abidjan.net/rss/',                           name: 'Abidjan.net CI' },
  { url: 'https://www.malijet.com/rss',                            name: 'Malijet ML' },
  { url: 'https://lefaso.net/rss.php',                             name: 'LeFaso BF' },
  { url: 'https://www.nigerdiaspora.info/feed/',                   name: 'Niger Diaspora' },
  { url: 'https://www.cameroon-tribune.cm/rss.xml',               name: 'Cameroon Tribune' },
  // ── 동아프리카·뿔 추가 ──────────────────────────────────
  { url: 'https://www.garoweonline.com/en/rss',                    name: 'Garowe Online SO' },
  { url: 'https://hiiraan.com/feed/',                              name: 'Hiiraan Online SO' },
  { url: 'https://www.shabelle.net/feed/',                         name: 'Shabelle SO' },
  { url: 'https://addisstandard.com/feed/',                        name: 'Addis Standard ET' },
  { url: 'https://www.ezega.com/News/rss.aspx',                    name: 'Ezega ET' },
  { url: 'https://sudantribune.com/feed/',                         name: 'Sudan Tribune' },
  { url: 'https://www.dabangasudan.org/en/feed/',                  name: 'Dabanga Sudan' },
  { url: 'https://www.radiotamazuj.org/en/rss.xml',               name: 'Radio Tamazuj SS' },
  { url: 'https://www.eyeradio.org/feed/',                         name: 'Eye Radio SS' },
  // ── 분쟁지역 특화 ────────────────────────────────────────
  { url: 'https://www.aa.com.tr/en/rss/default?cat=world',         name: 'Anadolu Agency' },
  { url: 'https://english.wafa.ps/rss.aspx',                       name: 'WAFA Palestine' },
  { url: 'https://www.palestinechronicle.com/feed/',               name: 'Palestine Chronicle' },
  { url: 'https://www.middleeastmonitor.com/feed/',                name: 'Middle East Monitor' },
  { url: 'https://www.almasdarnews.com/feed/',                     name: 'Al Masdar News SY' },
  { url: 'https://www.syriahr.com/en/feed/',                       name: 'Syrian Observatory' },
  { url: 'https://english.enabbaladi.net/feed/',                   name: 'Enab Baladi SY' },
  { url: 'https://www.yemenipress.net/archives/feed',              name: 'Yemeni Press' },
