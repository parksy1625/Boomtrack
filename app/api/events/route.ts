...
const NEWS_FEEDS: Array<{ url: string; name: string }> = [
  ...
  { url: 'https://www.tanzaniadailynews.co.tz/feed/',              name: 'Tanzania Daily News' },
  { url: 'https://www.ippmedia.com/frontend/feed/rss',             name: 'IPP Media TZ' },
  { url: 'https://malawilii.org/feed',                             name: 'Malawi LII' },
  { url: 'https://www.nation.africa/kenya/rss',                    name: 'Nation Africa KE' },
  { url: 'https://www.africanews.com/feed/rss',                    name: 'Africanews' },
  { url: 'https://www.voanews.com/api/zkvmeepiqyo',                name: 'VOA Africa' },
  ...
  { url: 'https://www.newsday.co.zw/feed/',                        name: 'NewsDay ZW' },
  { url: 'https://www.lusakatimes.com/feed/',                      name: 'Lusaka Times ZM' },
  { url: 'https://zambianobserver.com/feed/',                      name: 'Zambian Observer' },
  { url: 'https://www.mwebantu.com/feed/',                         name: 'Mwebantu ZM' },
  { url: 'https://www.mozambiquenews.com/feed/',                   name: 'Mozambique News' },
  { url: 'https://www.rfi.fr/en/rss',                              name: 'RFI English' },
  { url: 'https://www.rfi.fr/fr/rss',                              name: 'RFI Français' },
  { url: 'https://www.dw.com/rss/rss/rss-afr.xml',                name: 'DW Africa RSS' },
  // ── 중동 심층 추가 ───────────────────────────────────────
  ...
  { url: 'https://www.khaleejtimes.com/rss',                       name: 'Khaleej Times UAE' },
  { url: 'https://www.egyptindependent.com/feed/',                 name: 'Egypt Independent' },
  { url: 'https://www.egypttoday.com/rss',                         name: 'Egypt Today' },
  // ── 남아시아 심층 추가 ───────────────────────────────────
  { url: 'https://www.thedailystar.net/rss.xml',                   name: 'The Daily Star BD' },
  { url: 'https://bdnews24.com/rss',                               name: 'bdnews24 BD' },
  { url: 'https://www.prothomalo.com/feed',                        name: 'Prothom Alo BD' },
  { url: 'https://www.dailymirror.lk/RSS',                         name: 'Daily Mirror LK' },
  { url: 'https://www.ft.lk/rss',                                  name: 'FT Sri Lanka' },
  { url: 'https://www.newsfirst.lk/feed/',                         name: 'Newsfirst LK' },
  ...
  { url: 'https://www.khabarhub.com/rss',                          name: 'Khabarhub NP' },
  ...
  { url: 'https://www.nation.com.pk/rss',                          name: 'The Nation PK' },
  { url: 'https://www.arianews.com/rss',                           name: 'Aria News AF' },
  ...
  { url: 'https://www.khmertimeskh.com/feed/',                     name: 'Khmer Times' },
  { url: 'https://en.vietstock.vn/rss',                            name: 'VietStock EN' },
  ...
  { url: 'https://www.bnionline.net/rss.xml',                      name: 'BNI Myanmar' },
  ...
  { url: 'https://www.theedgemarkets.com/rss.xml',                 name: 'The Edge MY' },
  { url: 'https://www.freemalaysiatoday.com/feed/',                name: 'Free Malaysia Today' },
  // ── 동아시아 심층 추가 ───────────────────────────────────
  ...
  { url: 'https://koreajoongangdaily.joins.com/rss/feeds.xml',     name: 'Korea JoongAng Daily' },
  ...
  { url: 'https://acleddata.com/feed/',                            name: 'ACLED Blog' },
  { url: 'https://www.sipri.org/rss.xml',                          name: 'SIPRI' },
  { url: 'https://www.iiss.org/rss',                               name: 'IISS' },
  { url: 'https://www.rand.org/rsicle/latest.xml',                 name: 'RAND' },
  { url: 'https://foreignpolicy.com/feed/',                        name: 'Foreign Policy' },
  { url: 'https://www.foreignaffairs.com/rss.xml',                 name: 'Foreign Affairs' },
  { url: 'https://warontherocks.com/feed/',                        name: 'War on the Rocks' },
  ...
  { url: 'https://www.atomicarchive.com/rss.xml',                  name: 'Atomic Archive' },
  // ── 보건·전염병 특화 추가 ───────────────────────────────
  { url: 'https://www.promedmail.org/rss/',                        name: 'ProMED' },
  { url: 'https://outbreaksnewstoday.com/feed/',                   name: 'Outbreak News Today' },
  { url: 'https://www.contagionlive.com/rss/news',                 name: 'Contagion Live' },
  { url: 'https://www.infectiousdiseaseadvisor.com/rss/home',      name: 'ID Advisor' },
  { url: 'https://www.ecdc.europa.eu/en/rss.xml',                  name: 'ECDC EU' },
  { url: 'https://www.who.int/feeds/entity/csr/don/en/rss.xml',   name: 'WHO Disease Outbreak News' },
  // ── 기후·자연재해 특화 추가 ─────────────────────────────
  { url: 'https://www.carbonbrief.org/feed',                       name: 'Carbon Brief' },
  { url: 'https://www.desmog.com/feed/',                           name: 'DeSmog' },
  { url: 'https://insideclimatenews.org/feed/',                    name: 'Inside Climate News' },
  { url: 'https://e360.yale.edu/feed.rss',                         name: 'Yale E360' },
  { url: 'https://www.disastersafety.org/news/feed/',              name: 'IBHS Disaster Safety' },
  { url: 'https://reliefweb.int/updates/rss.xml',                  name: 'ReliefWeb Updates' },
  // ── 사이버·기술 안보 추가 ───────────────────────────────
